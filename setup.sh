...
paru -S --noconfirm qt5-graphicaleffects qt5-quickcontrols2 qt5-svg input-remapper-bin fuse2 python311 cmake pyqt5 openrgb zen-browser-bin discord visual-studio-code-bin spotify-launcher nemo nemo-fileroller hyprpaper eog vlc
