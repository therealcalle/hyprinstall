...
paru -S --noconfirm qt5-graphicaleffects qt5-quickcontrols2 qt5-svg zen-browser-bin discord visual-studio-code-bin spotify-launcher nemo nemo-fileroller hyprpaper eog vlc
